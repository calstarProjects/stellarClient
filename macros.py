...
class macroWidget(QWidget):
    ...
    def loadUI(self):
        ...
        self.macrosLabel.setFont(QFont('Castellar', 35))
        self.autoClickButton.setFont(QFont('Castellar', 25))
        self.circleButton.setFont(QFont('Castellar', 25))
        self.autoKeyButton.setFont(QFont('Castellar', 25))
        self.holdKeyButton.setFont(QFont('Castellar', 25))
